// // src/components/LayoutBuilder/LayoutCanvas.jsx
...
// // Correct DND_ITEM_TYPES and import generateUniqueId
// import { DND_ITEM_TYPES, DEFAULT_BLOCK_PROPS, generateUniqueId } from '../../utils/constants';
// import { pixelToGridCoordinates } from '../../utils/layoutHelpers';

// function LayoutCanvas() {
//   const { layout, gridSettings, addBlock } = useLayout();
//   const gridRef = useRef(null);

//   const gridRect = useRef(null);
//   useLayoutEffect(() => {
//     if (gridRef.current) {
//       gridRect.current = gridRef.current.getBoundingClientRect();
//     }
//   }, [gridSettings, layout]);

//   const [{ isOver }, drop] = useDrop(() => ({
//     // Use the DND_ITEM_TYPES from your provided constants.js
//     accept: DND_ITEM_TYPES.BLOCK_TYPE,
//     drop: (item, monitor) => {
//       const clientOffset = monitor.getClientOffset();
//       if (!clientOffset || !gridRect.current) return;

//       const { gridColumnStart, gridRowStart } = pixelToGridCoordinates(
//         clientOffset.x,
//         clientOffset.y,
//         gridRect.current,
//         gridSettings.columns,
//         parseFloat(gridSettings.rowHeight),
//         gridSettings.columnGap,
//         gridSettings.rowGap
//       );
...
//     }),
//   }), [gridSettings, addBlock]);

//   // Dynamically create grid styles from gridSettings
//   const gridStyle = {
//     display: 'grid',
//     gridTemplateColumns: `repeat(${gridSettings.columns}, 1fr)`,
//     // NEW: Conditionally apply gridTemplateRows or gridAutoRows
//     gridTemplateRows: gridSettings.rows > 0 ? `repeat(${gridSettings.rows}, ${gridSettings.rowHeight})` : undefined,
//     gridAutoRows: gridSettings.rows <= 0 ? gridSettings.rowHeight : undefined, // Only apply if rows is 0 or less (auto)
...
//         drop(el);
//       }}
//       className={`${styles.layoutCanvas} ${isOver ? styles.layoutCanvasDropping : ''}`}
//       style={gridStyle}
//     >
//       {layout.map((block) => (
//         <GridBlock key={block.id} block={block} />
//       ))}
//       {/* Removed the explicit green overlay div here as it's now handled by the class */}
//     </div>
//   );
// }
